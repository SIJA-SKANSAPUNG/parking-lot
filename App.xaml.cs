...
namespace ParkingOut
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            // Register services
            var logger = new AppLoggerImpl();
            ServiceLocator.RegisterService<IAppLogger>(logger);
            ...
            ServiceLocator.RegisterService<IPrintService>(new PrintService(logger));
            ServiceLocator.RegisterService<ICameraService>(new CameraService(logger));
